...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    "appIdea" : MessageLookupByLibrary.simpleMessage("本app的创意来源于即刻APP【今天是周五吗？】圈子（在主页面点击左下角按钮可以直接跳转）"),
    "appName" : MessageLookupByLibrary.simpleMessage("今天是周五吗？"),
    "bgColor" : MessageLookupByLibrary.simpleMessage("背景颜色"),
    "bubbleColor" : MessageLookupByLibrary.simpleMessage("气泡颜色"),
    ...
    "logoIdea" : MessageLookupByLibrary.simpleMessage("本app的LOGO风格来源于即刻APP的字体风格，由即友开发的网站生成。"),
    "mainColorInfo" : MessageLookupByLibrary.simpleMessage("主颜色白色（#F8F8F8）/蓝色（#01A9F4）/黄色（#FFE411）/黑色（#404040）取自即刻web端网站（颜色值不一定准确）"),
    "moreColor" : MessageLookupByLibrary.simpleMessage("更多颜色"),
